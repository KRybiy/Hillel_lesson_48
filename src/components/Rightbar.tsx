    ...
    <Box flex={2} sx={{ display: { xs: "none", md: "block" } }}>
      <Box position={"fixed"} p={2}>
        ...
        <AvatarGroup max={5}>
          ...
          <Avatar alt="Jack Donahue" src="https://mui.com/static/images/avatar/6.jpg" />
          <Avatar alt="Frida Kahlo" src="https://mui.com/static/images/avatar/7.jpg" />
        </AvatarGroup>
        ...
        <ImageList cols={3} rowHeight={100} gap={5}>
          ...
          <ImageListItem>
            <img src="https://mui.com/static/images/image-list/mushroom.jpg" alt="" />
          </ImageListItem>
          <ImageListItem>
